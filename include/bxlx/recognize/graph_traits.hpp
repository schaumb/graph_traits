...
struct graph_traits<G, V, true> {
  ...
  constexpr static bool has_graph_property = properties_t::template has_property_v<state_machine::graph_prop_t>;
  constexpr static bool has_edge_property = properties_t::template has_property_v<state_machine::edge_prop_t>;
  constexpr static bool has_node_property = properties_t::template has_property_v<state_machine::node_prop_t>;
  ...
  constexpr static bool has_node_container = properties_t::template has_property_v<state_machine::node_container<next_type::Dummy>>;
  constexpr static bool has_edge_container = properties_t::template has_property_v<state_machine::edge_container<next_type::Dummy>>;

  constexpr static bool has_adjacency_container = properties_t::template has_property_v<state_machine::adj_list_cont<next_type::Dummy>> ||
                                                  properties_t::template has_property_v<state_machine::adj_mat_cont<next_type::Dummy>> ||
  ...
  constexpr static bool has_in_adjacency_container = properties_t::template has_property_v<state_machine::indexed_type<state_machine::adj_list_cont<next_type::Dummy>, 1>> ||
                                                     properties_t::template has_property_v<state_machine::indexed_type<state_machine::adj_mat_cont<next_type::Dummy>, 1>>;
...
#define BXLX_GRAPH_TRAITS_SIMPLIFY_GETTER(member) [] { \
